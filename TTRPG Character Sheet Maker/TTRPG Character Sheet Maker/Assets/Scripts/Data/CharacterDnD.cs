...
namespace TTRPG.Data
{
    ...
    public class CharacterDnD : Character
    {
        ...
        public Feat[] feats;
        public VitalsDnD vitals;

        public CharacterDnD() { }
        public CharacterDnD(string playerName, string characterName, int characterLevel, string race, string character_class, AbilityScoresDnD ability_scores, Feat[] feats, VitalsDnD vitals)
